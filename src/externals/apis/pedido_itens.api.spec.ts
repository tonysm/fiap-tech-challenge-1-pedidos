...
describe('PedidoItensAPI', () => {
    ...
    it('creates', async () => {
        ...
        jest.spyOn(controller, 'addItem').mockImplementation(async (aPedido, aItem) => {
            usedPedido = aPedido
            usedItem = aItem
    ...
    it('updates itens', async () => {
        ...
        jest.spyOn(controller, 'updateItem').mockImplementation(async (pedidoId, itemId, input) => {
    ...
    it('remove item', async () => {
        ...
        jest.spyOn(controller, 'removeItem').mockImplementation(async (pedidoId, itemId) => {
            usedPedidoId = pedidoId
            usedItemId = itemId
